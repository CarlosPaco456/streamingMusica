    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                ...
                <a href="<?= base_url('index') ?>"><img src="<?= base_url('assets/img/logo.png') ?>" alt=""></a>
                </div>
            </div>
            <div class="col-lg-10">
                    <ul>
                    <li class="active"><a href="<?= base_url('index') ?>">Homepage</a></li>
                        <li><a href="<?= base_url('categories') ?>">Categories</a></li>
                        <li><a href="<?= base_url('blog') ?>">Our Blog</a></li>
                        <li><a href="<?= base_url('contacts') ?>">Contactos</a></li>
                        <li><a href="<?= base_url('/usuarios') ?>">Usuario</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3">
